...
public class GivingBackSprint implements Parcelable{
        ...
        public GivingBackSprint(String categoryid, String endingDate, String goal1, String goal2, String goal3, String goal4, String numberOfWeeks, String sprintActivityid1,
        ...
        public GivingBackSprint(Parcel in){
        ...
        public static final Parcelable.Creator<GivingBackSprint> CREATOR = new Parcelable.Creator<GivingBackSprint>() {
            public GivingBackSprint createFromParcel(Parcel in) {
                return new GivingBackSprint(in);
            }

            @Override
            public GivingBackSprint[] newArray(int i) {
                return new GivingBackSprint[i];
            }
        };
